...
% \begin{tabular}{ll}
%     $\grbm{C}\grbmask{\grbm{M}}$                 & compute for nodes selected by the values of $\grbm{M}$ & keep       \\
%     $\grbm{C}\grbmaskreplace{\grbm{M}}$          & compute for nodes selected by the values in $\grbm{M}$ & discard  \\
%     $\grbm{C}\grbmask{\grbstr{\grbm{M}}}$        & compute for nodes selected by the pattern of $\grbm{M}$ & keep      \\
%     $\grbm{C}\grbmaskreplace{\grbstr{\grbm{M}}}$ & compute for nodes selected by the pattern of $\grbm{M}$ & discard \\
% \end{tabular}
