...
Recently, numerous graph processing systems have targeted GPUs such as the \mbox{GraphBLAS Template Library (GBTL)}~\cite{DBLP:conf/ipps/ZhangZLMM16}, Gunrock~\cite{DBLP:journals/topc/WangPDWYWOYLRO17} and \mbox{GraphBLAST}~\cite{DBLP:journals/corr/abs-1908-01407}, as well as FPGAs~\cite{DBLP:journals/corr/abs-1903-06697}.
